...
namespace Pokemon
{
    ...
    public partial class Search
    {
        public static Search FromJson(string json) => JsonConvert.DeserializeObject<Search>(json, Pokemon.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Search self) => JsonConvert.SerializeObject(self, Pokemon.Converter.Settings);
    }
